...
**Utility**. 10,000 first unique token holders (as informed by the [Famous Fox Federation](https://famousfoxes.com/snapshot)) will be manually whitelisted on [LaunchMyNFT](https://launchmynft.io/sol/3019) for a **90% off** discount on Matrix Jouyou NFT mints (that is, at **0.1 SOL** per mint). In case of any future Matrix Jouyou NFT sales or resales directly by the dev team, $KANA token holders will enjoy a special fixed price of 2.2419724937983365 カナ per 1 \|<span style="padding: 0 0.5em"></span>\| NFT. That price is based on the evidence that it takes an average of this many kana to spell one kanji, which can be verified using [Wikipedia’s jōyō kanji data](https://en.wikipedia.org/wiki/List_of_j%C5%8Dy%C5%8D_kanji) and the attached [Python script](/kanji2kana.py).
