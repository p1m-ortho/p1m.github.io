...
- 🈹 As of May 3, 2024, minting is available to [$KANA Token](#kana-token) holders only at **90% off** for SOL 0.1 per mint. Owning any quantity of $KANA is sufficient to be whitelisted, so feel free to get some on <a href="https://pump.fun/3ypoSTW4d1j7bVwcmsQGmrcpJg1sn1hAJLYr3APbJGG1" target="_blank"><img style="height: 22.5px; width: 22.5px;" src="/pump.fun.png" alt="Pump.fun" /> Pump.fun</a> and enjoy the discounted Matrix Jouyou minting price.
...
$KANA contract address: <small><a href="https://solscan.io/token/3ypoSTW4d1j7bVwcmsQGmrcpJg1sn1hAJLYr3APbJGG1" target="_blank"><code>3ypoSTW4d1j7bVwcmsQGmrcpJg1sn1hAJLYr3APbJGG1</code></a></small>

The token was conceived in early May 2024 as a promo mechanism to support the Matrix Jouyou Genesis NFT campaign. The idea is to engage the DeFi community by offering an original meme coin idea on <a href="https://pump.fun/3ypoSTW4d1j7bVwcmsQGmrcpJg1sn1hAJLYr3APbJGG1" target="_blank"><img style="height: 22.5px; width: 22.5px;" src="/pump.fun.png" alt="Pump.fun" /> Pump.fun</a> and presenting Matrix Jouyou to a wider audience. <a href="https://twitter.com/tokenkana" target="_blank"><img style="height: 22.5px; width: 22.5px;" src="/x.com.svg" alt="X (Twitter)" /></a> <a href="https://t.me/tokenkana" target="_blank"><img style="height: 22.5px; width: 22.5px;" src="/t.me.svg" alt="Telegram" /></a> <a href="https://photon-sol.tinyastro.io/en/lp/3WrwsQ4ohvyrnUpgZFPevQ7PyKchp9tPQ2wJCN7SecHx" target="_blank"><img style="height: 22.5px; width: 22.5px;" src="/photon-sol.svg" alt="Photon" /></a>

**Tokenomics**. Typical for a fair meme coin and involve a burned <a href="https://beta.raydium.io/" target="_blank"><img style="height: 22.5px; width: 22.5px;" src="/raydium.io.svg" alt="Raydium" /> Raydium</a> liquidity pool (seeded from a Pump.fun bonding curve) with no presale, no airdrops, and no team allocation. At token creation, the dev [bought](https://solscan.io/tx/4DAGyp4bYZsEVybfXaX7As3HrFrpfV8tDyDvVVkSDz4oGqMZMoiGXRVkjnP9oPQhNrboRJR9Pf5pzHWNk6c5sP27) 0.03 SOL worth of $KANA (1,071,928.071928 カナ), which is a good tradeoff between the costs (0.03 SOL + cost to deploy ~0.02 SOL for a total of 0.053078 SOL), Pump.fun’s suggestion that “buying a small amount of coins helps protect your coin from snipers,” and market impact (~0.1% of total supply). Other than that, the price of $KANA is determined by market forces. No additional liquidity will be provided by the dev. The token supply was enforced by Pump.fun and set forever at 1 billion $KANA, with the mint and freeze authorities disabled.

**Utility**. 10,000 first unique token holders (as informed by the [Famous Fox Federation](https://famousfoxes.com/snapshot)) are manually whitelisted on a rolling basis on [LaunchMyNFT](https://launchmynft.io/sol/3019) for a **90% off** discount on Matrix Jouyou NFT mints (that is, at **0.1 SOL** per mint). There is not strict whitelist update schedule, so if you are a token holder and want to speed up your adding on the whitelist, please leave a message in the [Telegram chat](https://t.me/tokenkana). In case of any future Matrix Jouyou NFT sales or resales directly by the dev team, $KANA token holders will enjoy a special fixed price of 2.2419724937983365 カナ per 1 \|<span style="padding: 0 0.5em"></span>\| NFT. That price is based on the evidence that it takes an average of this many kana to spell one kanji, which can be verified using [Wikipedia’s jōyō kanji data](https://en.wikipedia.org/wiki/List_of_j%C5%8Dy%C5%8D_kanji) and the attached [Python script](/kanji2kana.py).
